...
_DUP_METRICS = ("test_metrics_file17.py::test_duplicate_series_summary_cong_thuc_va_mau_so_n_groups_bang_observation_tru_observation_du",
                ...
                "test_metrics_file17.py::test_duplicate_series_audit_sample_du_dong_moi_nhom_gia_rank_va_raise_khi_lech")
_DUP_E2E = "test_wave_a_dry_run.py::test_duplicate_series_tables_e2e_khop_metric_sql_va_audit_sample_tren_fixture"
_NULL_METRICS = ("test_metrics_file17.py::test_null_taxonomy_by_source_phan_hoach_day_du_va_tong_khop_bang_goc",
                 "test_metrics_file17.py::test_null_class_summary_du_3_lop_mau_so_rieng_va_tong_khop",
                 "test_metrics_file17.py::test_required_field_null_stats_free_cancellation_co_mau_so_rieng_khong_chim_trong_tong_cell",
                 "test_null_taxonomy.py::test_registry_phu_dung_missingness_field_groups_that")
_NULL_E2E = "test_wave_a_dry_run.py::test_quality_findings_tach_theo_lop_null_khong_con_unexpected_gop"
_ANCHOR_METRICS = ("test_metrics_file17.py::test_item_coverage_with_anchors_friday_1_anchor_va_tong_anchor_theo_thu_bang_tong_anchor",
                   "test_metrics_file17.py::test_checkin_anchor_dates_table_1_dong_moi_anchor_va_co_calendar_any_city")
_ANCHOR_E2E = "test_wave_a_dry_run.py::test_anchor_tables_e2e_tong_anchor_theo_thu_bang_tong_anchor_va_gia_theo_thu_co_n_distinct"
...
_ROWS: list[dict] = [
    ...
    R("7.2", "collision audit theo `(crawl_date, checkin_date, hotel_id)`;",
      ...
      T("collision_item_pairs", "collision_item_status_concordance", "collision_item_summary", "collision_item_time_diff_stratification", "collision_option_detail",
        "collision_option_pair_coverage", "collision_option_summary", "collision_option_coverage_summary", "collision_option_time_diff_stratification",
        "collision_option_near_time_concentration"),
      ...
      (_COLLISION, "test_metrics.py::test_collision_item_summary_mau_so_rieng_cho_tung_lop", "test_metrics.py::test_collision_option_summary_mau_so_la_shared_option_pairs",
       ...
       "test_metrics_file17.py::test_collision_near_time_concentration_chi_bucket_0_5_va_cho_thay_tap_trung")),
    ...
    R("7.3", "Ngày có duration/error/block/sold-out bất thường.",
      ...
      T("run_day_operational_flags", "run_day_operational_flags_raw_appendix", "run_day_status_counts_raw", "run_day_error_code_counts_raw"),
      "source-day (source x vn_crawl_date); bang chinh = source-day production", "PROTOCOL (chinh) / RAW (phu luc)",
      "n_items RAW cua source-day; z-score tren phan phoi source-day production cua nguon (pilot khong dinh hinh baseline)",
      ("test_metrics.py::test_daily_operational_anomaly_flags_bat_ngay_duration_va_error_bat_thuong_khong_loc_ngay_nao",
       ...
       "test_metrics.py::test_pilot_cuc_ngan_khong_lam_thay_doi_co_anomaly_production_file_17_m2",
       "test_sql_catalog_integration.py::test_run_duration_is_protocol_run_theo_etl_run_map_va_pilot_khong_lot_vao_baseline",
    ...
    R("7.4", "Check-in month, weekday/weekend, lead-time bucket coverage.",
      ("metrics.item_coverage_count", "metrics.item_coverage_with_anchors", "metrics.checkin_anchor_dates_table", "item_checkin_month_distribution_main",
       "item_checkin_weekday_distribution_main", "item_lead_time_bucket_distribution_main", "checkin_month_distribution_main", "checkin_weekday_distribution_main",
       "lead_time_bucket_distribution_main", "checkin_anchor_dates_main"),
      T("item_checkin_month_distribution_main", "item_checkin_weekday_distribution_main", "item_lead_time_bucket_distribution_main",
        "checkin_month_distribution_main", "checkin_weekday_distribution_main", "lead_time_bucket_distribution_main", "checkin_anchor_dates_main")
      + F("checkin_coverage_weekday_month"), "item (primary) / observation (appendix); kem so ngay anchor phan biet", "MAIN",
      "owned MAIN item; observation MAIN co gia chi la phu luc option-weighted",
      ("test_metrics.py::test_item_coverage_count_khong_bi_room_option_weighting", *_ANCHOR_METRICS, _ANCHOR_E2E,
       "test_plots.py::test_weekday_month_plot_ghi_so_ngay_anchor_len_moi_cot_file_17_m4", _VALUES)),
    R("7.4", "Cohort attrition theo version; Mac Valley được ghi nhận đúng trước khi rời cohort.", ("metrics.cohort_attrition_table",), T("cohort_attrition_by_version"),
      "cohort version", "CONFIG", "khong co - bang mo ta", ("test_metrics.py::test_cohort_attrition_table_danh_dau_dung_attrition",
                                                            "test_plots.py::test_active_hotel_plot_chu_thich_cohort_transition_file_17_minor_2")),
    ...
    R("7.6", "Weekday/weekend của check-in.", ("item_checkin_weekday_distribution_main", "checkin_weekday_distribution_main", "metrics.item_coverage_with_anchors"),
      T("item_checkin_weekday_distribution_main", "checkin_weekday_distribution_main", "checkin_anchor_dates_main") + F("checkin_coverage_weekday_month"),
      "item (primary) / observation (appendix); kem so ngay anchor", "MAIN", "owned MAIN item",
      ("test_metrics.py::test_item_coverage_count_khong_bi_room_option_weighting", *_ANCHOR_METRICS, _ANCHOR_E2E)),
    R("7.6", "Check-in month.", ("item_checkin_month_distribution_main", "checkin_month_distribution_main", "metrics.item_coverage_with_anchors"),
      T("item_checkin_month_distribution_main", "checkin_month_distribution_main"), "item (primary) / observation (appendix); kem so ngay anchor", "MAIN", "owned MAIN item",
      ("test_metrics.py::test_item_coverage_count_khong_bi_room_option_weighting", *_ANCHOR_METRICS)),
    ...
    *[R("7.6", f"`{flag}`{';' if flag != 'provisional_event_count' else '.'}", ("holidays.checkin_calendar_flags",), T("holiday_calendar_flags_by_checkin_date_city"),
    ...
    R("7.11", "duplicate daily series;", ("quality_duplicate_daily_series", "duplicate_series_groups", "duplicate_series_observation_totals",
                                          "metrics.duplicate_series_summary", "metrics.duplicate_series_price_spread_summary", "metrics.duplicate_series_audit_selection",
                                          "metrics.duplicate_series_audit_sample"),
      _QF + T("duplicate_series_summary_by_source_city", "duplicate_series_price_spread_summary", "duplicate_series_audit_sample"),
      "item x canonical key", "RAW (+MAIN)", "nhom (item, canonical key) khong sold-out; n_groups = observation - observation du",
      ("test_sql_catalog_integration.py::test_quality_duplicate_daily_series_bat_duoc_2_option_trung_canonical_key",
       "test_sql_catalog_integration.py::test_duplicate_series_groups_va_totals_khop_quality_metric_khi_tiem_duplicate", *_DUP_METRICS, _DUP_E2E)),
    ...
    R("7.11", "success item không observation;", ("quality_success_item_without_observation",), _QF, "item", "MAIN", "success MAIN item",
      ("test_sql_catalog_integration.py::test_quality_success_item_khong_observation_va_city_ngoai_scope",)),
    R("7.11", "unexpected NULL theo field group;",
      ("null_taxonomy.registry_dataframe", "metrics.null_taxonomy_by_source", "metrics.null_class_summary", "metrics.required_field_null_stats"),
      _QF + T("null_taxonomy_registry", "missingness_null_taxonomy", "missingness_null_class_summary", "missingness_required_contract_by_field",
              "missingness_by_item_status_sold_out"), "field_value_cell (lop) / observation (required_contract theo field)", "MAIN",
      "n_total cua tung lop; observation cua chinh field cho finding required_null_<field>", (*_NULL_METRICS, _NULL_E2E, _VALUES)),
    ...
    R("7.11", "collision/source divergence đáng chú ý.", ("collision_item_pairs", "collision_option_detail", "collision_option_near_time_concentration"),
      _QF + T("collision_item_summary", "collision_option_summary", "collision_option_near_time_concentration"),
